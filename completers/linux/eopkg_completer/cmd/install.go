...
func init() {
	...
	installCmd.Flags().Bool("ignore-revdeps-of-deps-check", false, "don't check for updates in reverse dependencies of runtime dependencies when updates are available")
